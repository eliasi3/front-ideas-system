    ...
    <center>
        ...
        v-for="(missions, i) in isMission" :key="i">
            ...
            <tbody class="bg-white bg-gray-800">
                    ...
                    <tr>
                        <td class="border-b border-gray-100 dark:border-gray-700 p-2 pl-3 text-gray-500 dark:text-gray-400" colspan='3'><span style='font-size:25px;'>#Título: {{missions.mis_name.toUpperCase()}}</span><br><b>CRIADOR: </b>{{missions.user.user_name}}, {{missions.dept.dep_name}}</td>
                    </tr>
                    <tr>
