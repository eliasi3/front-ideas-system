                    ...
                    <div class="relative ml-3">
                        <div> 
                         ...
                         <!-- Active: "bg-gray-100", Not Active: "" -->
                                ...
                                <span class='block px-4 py-2 text-sm text-gray-700'><router-link class="btn btn-primary" :to="{name: 'listcomments'}">Comentario</router-link></span>
                 ...
                 <div class="flex items-center ml-4 md:ml-6">
                        ...
                        <div> 
                         ...
                         <!-- Active: "bg-gray-100", Not Active: "" -->
                                ...
                                <a href="#" class="block px-4 py-2 text-sm text-gray-700" role="menuitem" tabindex="-1" id="user-menu-item-0"><router-link class="btn btn-primary" :to="{name: 'editperfil'}">Seu perfil</router-link></a>
