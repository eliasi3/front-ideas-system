...
<div class="min-w-screen min-h-screen flex items-center justify-center px-5 py-5" style="margin-top:-10px; margin-bottom:-90px"> 
        ...
        <div class="md:flex w-full">
            ...
            <div class="w-full md:w-1/1 py-10 px-5 md:px-10">
                <div class="text-center mb-100">
                    <h1 class="font-bold text-3xl text-gray-900">CADASTRAR USUÁRIO</h1>
                    <p>{{ error.message }}</p>
                </div>
                ...
                <div>
                    <div class="text-center">
                        <div class="w-full px-3 mb-5">
                            ...
                            <label for="" class="text-xs font-semibold px-1">Telefone</label>
                            <div class="text-center">
                                <input type="text"  class=" -ml-10 pl-10 pr-3 py-2 border-5 border-black-500 outline-none focus:border-indigo-500 text-center" placeholder="nome do departamento" >
                            </div>
                            <label for="" class="text-xs font-semibold px-1">Departamento</label>
                            <div class="text-center">
                                <input type="text"  class=" -ml-10 pl-10 pr-3 py-2 border-5 border-black-500 outline-none focus:border-indigo-500 text-center" placeholder="nome do departamento" >
                            </div>
    ...
    export default {
        data(){
            return {
                ...
                error: {
                    error: false,
                    message: 'Digite as informações do Usuário!'
                }
            }
        },
        methods: {
