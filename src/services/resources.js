...
const Userdept = Vue.resource(`http://localhost:3000/users?dept_id={dept_id}&search={search`);
...
const Idept = Vue.resource(`http://localhost:3000/missions?dept_id={dept_id}&search={search}`);
